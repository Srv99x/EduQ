            ...
            <div className="flex gap-2">
                <div className="relative group flex-1">
                    ...
                    <input 
                        ...
                        className="w-full bg-surface/70 border border-white/15 rounded-xl py-2 pl-9 pr-3 text-sm text-white focus:outline-none focus:border-primary/60 focus:bg-surface/90 transition-all placeholder:text-subtext"
                    />
                </div>
